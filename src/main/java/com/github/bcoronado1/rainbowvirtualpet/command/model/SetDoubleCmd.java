...
/**
 * Generic command to set a double value in the Acme model specific to the PetSys system.
 */
public abstract class SetDoubleCmd extends PetAcmeModelCmd<IAcmeProperty> {

    protected String componentName;
    protected String propertyName;
    protected double value;

    public SetDoubleCmd(AcmeModelInstance model, String commandName, String componentName, String propertyName, String valueString) {
    ...
    protected List<IAcmeCommand<?>> doConstructCommand() throws RainbowModelException {
        ...
        try {
            IAcmeFloatingPointValue acmeVal = PropertyHelper.toAcmeVal(this.value);
